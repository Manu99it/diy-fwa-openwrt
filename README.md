...
graph TD
    ...
    style TP_Link_C6_P2 fill:#bfb,stroke:#333,stroke-width:1px
...
* **Router di Confine:** Posizionamento in cascata di un router **Cudy WR3000H** (con porta WAN da **2.5 GbE** per non creare colli di bottiglia con il 5G) su cui è stato installato OpenWrt.
